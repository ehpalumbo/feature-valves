...
- **Java records + Lombok** — immutable domain value types (e.g. `Tag`, `FeatureId`, `FeatureCheck`), with Lombok generating getters/`toString` for the remaining behavior-bearing classes.
